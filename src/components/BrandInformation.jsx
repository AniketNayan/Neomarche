...
function BrandInformation() {
  ...
  const countryOptions = ['UAE - Abu Dhabi', 'UAE - Dubai', 'UAE - Sharjah', 'UAE - Ajman', 'UAE - Umm Al Quwain', 'UAE - Ras Al Khaimah', 'UAE - Fujairah'];
  ...
  return (
    <div className="w-[1440px] h-[1024px] relative bg-white overflow-hidden">
      ...
      {/* Submit Button */}
      <div className="size-6 left-[1360px] top-[941px] absolute cursor-pointer" onClick={handleSubmit}>
